  ...
  return (
    <section className="py-[clamp(3.4rem,7vw,6rem)]">
      <div className="mx-auto grid max-w-[1180px] grid-cols-1 items-center gap-10 px-6 lg:grid-cols-[0.85fr_1fr] lg:gap-14">
        <div className="relative order-first mx-auto w-full max-w-[480px] px-5 pb-8 pt-4 lg:order-none lg:max-w-none lg:px-3">
          <div className="absolute right-2 top-0 size-36 rounded-full bg-primary-50 sm:size-48" />
          <div className="absolute bottom-8 left-0 h-24 w-24 rounded-[28px] border border-primary-100 bg-accent/10 sm:h-32 sm:w-32" />
          <div className="relative aspect-[0.9] overflow-hidden rounded-[38px] bg-primary-50 shadow-[0_24px_55px_rgba(24,32,25,0.16)]">
            <SiteMedia url={mainImageUrl} fallback={FarmerIllustration} className="size-full object-cover" />
          </div>
          <div className="absolute bottom-0 left-0 aspect-[0.92] w-[42%] overflow-hidden rounded-[26px] border-[6px] border-white bg-white shadow-[0_18px_38px_rgba(24,32,25,0.18)] sm:rounded-[30px] sm:border-8">
            <SiteMedia url={accentImageUrl} fallback={BasketIllustration} className="size-full object-cover" />
          </div>
          <div className="absolute left-[58%] top-[48%] z-10 flex size-[96px] -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-[#10261a] text-accent shadow-[0_14px_28px_rgba(16,38,26,0.3)] sm:size-[118px]">
